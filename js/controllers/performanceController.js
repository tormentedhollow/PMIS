...
app.controller('PerformanceController',  function($scope, $cookies,$mdMedia, $mdDialog, $http, MFOBannerQService, getMFONameService, gePhysicalBannerService, getUnitService, getPhysicalMFOService){
...
*/
getPhysicalMFOService.async().then(function(d){
console.log(d);  
